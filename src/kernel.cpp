...
int nStakeTargetSpacing = 15 * 60; // Cent: 1 minute blocks during POS (block 201+)
...
{
    // Cent will hash in the transaction hash and the index number in order to make sure each hash is unique
