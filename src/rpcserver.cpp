...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cent features */
        {"cent", "masternode", &masternode, true, true, false},
        {"cent", "listmasternodes", &listmasternodes, true, true, false},
        {"cent", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cent", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cent", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cent", "masternodedebug", &masternodedebug, true, true, false},
        {"cent", "startmasternode", &startmasternode, true, true, false},
        {"cent", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cent", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cent", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cent", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cent", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cent", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cent", "mnbudget", &mnbudget, true, true, false},
        {"cent", "preparebudget", &preparebudget, true, true, false},
        {"cent", "submitbudget", &submitbudget, true, true, false},
        {"cent", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cent", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cent", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cent", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cent", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cent", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cent", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cent", "checkbudgets", &checkbudgets, true, true, false},
        {"cent", "mnsync", &mnsync, true, true, false},
        {"cent", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> cent-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9922/\n";
}
