...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (2160545, uint256("0xd604d64202854b105f806047116ef26d03faeb7248b704195a37105185ab6dd3"));


static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1547428701, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 2 * 60;  // Cent: 2 minute blocks during POW (block 1-200)
      ...
      vSeeds.emplace_back(CDNSSeedData("155.138.229.116", "155.138.229.116"));
      vSeeds.emplace_back(CDNSSeedData("45.76.179.95", "45.76.179.95"));


        // Cent addresses start with 'N'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 53);
        // Cent script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // Cent private keys start with 'K'
