...
//! These need to be macros, as clientversion.cpp's and cent*-res.rc's voodoo requires it
...
#if !defined(WINDRES_PREPROC) && !defined(RC_INVOKED)
#ifndef RC_INVOKED
#include <string>
#include <vector>
