...
// Copyright (c) 2026-Present Day The Centdevelopers
...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cent Core cent-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cent-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cent transaction") + "\n" +
                               "  cent-tx [options] -create [commands]   " + _("Create hex-encoded cent transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cent transaction
