...
sudo adduser --system --home /root/cent/home/cent cent1
...
sudo adduser --system --home /root/cent/home/cent5 cent5
sudo adduser --system --home /root/cent/home/cent6 cent6
...
tar -xvzf centlinux.tar.gz -C /root/cent
...
echo "maxconnections=250" >> /root/cent/home/cen1t/.cent/cent.conf
...
echo "rpcallowip=127.0.0.1" >> /root/cent/home/cent2/.cent/cent.conf
...
sudo mkdir -p /root/cent/home/cent5/.cent
sudo touch /root/cent/home/cent5/.cent/cent.conf
echo "rpcuser=user"`shuf -i 100000-10000000 -n 1` >> /root/cent/home/cent5/.cent/cent.conf
echo "rpcpassword=pass"`shuf -i 100000-10000000 -n 1` >> /root/cent/home/cent5/.cent/cent.conf
echo "rpcallowip=127.0.0.1" >> /root/cent/home/cent5/.cent/cent.conf
echo "server=1" >> /root/cent/home/cent5/.cent/cent.conf
echo "daemon=1" >> /root/cent/home/cent5/.cent/cent.conf
echo "maxconnections=250" >> /root/cent/home/cent5/.cent/cent.conf
echo "masternode=1" >> /root/cent/home/cent5/.cent/cent.conf
echo "rpcport=9926" >> /root/cent/home/cent5/.cent/cent.conf
echo "listen=1" >> /root/cent/home/cent5/.cent/cent.conf
echo "externalip=$(hostname  -I | cut -f1 -d' '):9922" >> /root/cent/home/cent5/.cent/cent.conf
echo "masternodeprivkey=$privkey5" >> /root/cent/home/cent5/.cent/cent.conf
echo "addnode=182.206.23.95" >> /root/cent/home/cent5/.cent/cent.conf
...
sudo mkdir -p /root/cent/home/cent6/.cent
sudo touch /root/cent/home/cent6/.cent/cent.conf
echo "rpcuser=user"`shuf -i 100000-10000000 -n 1` >> /root/cent/home/cent6/.cent/cent.conf
echo "rpcpassword=pass"`shuf -i 100000-10000000 -n 1` >> /root/cent/home/cent6/.cent/cent.conf
echo "rpcallowip=127.0.0.1" >> /root/cent/home/cent6/.cent/cent.conf
echo "server=1" >> /root/cent/home/cent6/.cent/cent.conf
echo "daemon=1" >> /root/cent/home/cent6/.cent/cent.conf
echo "maxconnections=250" >> /root/cent/home/cent6/.cent/cent.conf
echo "masternode=1" >> /root/cent/home/cent6/.cent/cent.conf
echo "port=9927" >> /root/cent/home/cent6/.cent/cent.conf
echo "listen=1" >> /root/cent/home/cent6/.cent/cent.conf
echo "externalip=$(hostname  -I | cut -f1 -d' '):9922" >> /root/cent/home/cent6/.cent/cent.conf
echo "masternodeprivkey=$privkey6" >> /root/cent/home/cent6/.cent/cent.conf
echo "addnode=182.206.23.95" >> /root/cent/home/cent6/.cent/cent.conf
...
sleep 10 
until /root/centcent-cli -datadir=/root/cent/home/cent1/.cent mnsync status | grep -m 1 '"IsBlockchainSynced": true,'; do sleep 1 ; done > /dev/null 2>&1
...
/root/cent/centd -datadir=/root/cent/home/cent6/.cent -daemon -listen=0
sleep 10 
