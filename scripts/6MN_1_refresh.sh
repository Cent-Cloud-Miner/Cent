...
echo -e ${YELLOW}"Welcome to the Cent Automated Update 1.0.2.1.0.0.3 (6in1)."${NC}
...
/root/cent/cent-cli -datadir=/home/cent4/.cent stop
...
until /root/cent/cent-cli -datadir=/root/cent/home/cent/.cent mnsync status | grep -m 1 '"IsBlockchainSynced": true,'; do sleep 1 ; done > /dev/null 2>&1
...
rm -rf /root/cent/6MN_1_refresh.sh
cd ~
