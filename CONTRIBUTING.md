Contributing to Cent Core
==================================

The Cent Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cent Core project, and is not to be
confused with overall Cent Network Protocol consensus changes.

Whether a pull request is merged into Cent Core rests with the project merge
...
Patches that change Cent consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cent consensus, it must have been
...
The project leader is the release manager for each Cent Core release.
