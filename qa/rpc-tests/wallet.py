...
#   c) node1 mines 32 blocks, so now node 0 has 500000 CENT, node 1 has 4250 CENT, node2 has none.
#   d) node0 sends 601 CENT to node2, in two transactions (301 CENT, then 300 CENT).
