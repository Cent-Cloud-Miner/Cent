...
This mechanism has been integrated into Bitcore-Node-Cent which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cent/insight-api-cent#web-socket-api](https://github.com/cent/insight-api-cent#web-socket-api)
* API: [https://github.com/cent/insight-api-cent#swifttx-transactions](https://github.com/cent/insight-api-cent#swifttx-transactions)
