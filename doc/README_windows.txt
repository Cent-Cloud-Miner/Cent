...
Intro
-----
Cent (CENT) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Cent utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run cent-qt.exe.

Cent Core is the original Cent client and it builds the backbone of the network.
However, it downloads and stores the entire history of Cent transactions;
