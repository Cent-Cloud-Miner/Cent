...
In order to support loading of multiple wallets in cent-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cent.cpp.
...
Changes to cent.cpp
----------------------
cent.cpp is the entry point into cent-qt, and as such, will require some minor modifications to provide hooks for
