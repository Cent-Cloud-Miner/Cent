...
If you are using a masternode.conf file you no longer need the cent.conf file. The exception is if you need custom settings (thanks oblox).

## Update cent.conf on server

If you generated a new masternode private key, you will need to update the remote cent.conf files.

Shut down the daemon and then edit the file.

```sudo nano .cent/cent.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote cent.conf file.
...
And compare with the official explorer at http://explorer.cent.network
